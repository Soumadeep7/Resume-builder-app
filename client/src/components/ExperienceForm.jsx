...
const generateDescription = async (index) => {
    ...
    if (!experience.position || !experience.company || !experience.description) {
        toast.error("Missing required fields for enhancement!");
    ...
    try {
        ...
        // Safely update experience with fallback
        const enhanced = response?.data?.enhancedContent || experience.description;
                ...
                {data.map((experience, index) => (
                    <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            onChange={(e) => updateExperience(index, "company", e.target.value)} type="text" 
                            placeholder="Company name" className="px-3 py-2 text-sm rounded-lg" />

                            <input value={experience.position || ""} 
                            onChange={(e) => updateExperience(index, "position", e.target.value)} type="text" 
                            ...
                            onChange={(e) => updateExperience(index, "end_date", e.target.value)} type="month" 
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea value={experience.description || ""} onChange={(e) => updateExperience(index,
                                "description", e.target.value)} rows={4} className="w-full text-sm px-3 py-2 rounded-lg resize-none"
