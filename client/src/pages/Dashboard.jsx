import { FileLockIcon, LoaderCircleIcon, PencilIcon, PlusIcon, TrashIcon, UploadCloud, UploadCloudIcon, XIcon } from 'lucide-react'
...
const loadAllResumes = async () => {
  try {
    ...
    setAllResumes(data.resumes);  // note: resumes (plural)
  } catch (error) {
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        text-transparent sm:hidden'>Welcome, Soumadeep Paul</p>
        ...
        <div className='flex gap-4'>
          ...
          transition-all duration-300 cursor-pointer'>
            <PlusIcon className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-indigo-500 to-indigo-500
          ...
          transition-all duration-300 cursor-pointer'>
            <UploadCloudIcon className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-purple-500 to-purple-500
            text-white rounded-full'/>
        ...
        <div className="grid grid -cols-2 sm:flex flex-wrap gap-4">
          {allResumes.map((resume, index)=>{
            ...
            return (
              ...
              gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer' style={{background:
                `linear-gradient(135deg, ${baseColor}10, ${baseColor}40)`,  borderColor: baseColor + '40'}}>

                <FileLockIcon className="size-7 group-hover:scale-105 transition-all" style={{color: baseColor}}/>
